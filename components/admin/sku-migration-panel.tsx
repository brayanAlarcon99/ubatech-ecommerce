...
export default function SKUMigrationPanel() {
  ...
  async function handleMigration() {
    setLoading(true)
    try {
      const response = await fetch("/api/migrate/sku", {
        method: "POST",
      })
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <p className="text-gray-600 mb-6">
        Este proceso agregará un código SKU único a todos los productos existentes que no tengan uno.
        Los productos que ya tengan SKU no serán modificados.
      </p>
      ...
      {!executed && (
        ...
        >
          {loading ? "Ejecutando migración..." : "Ejecutar Migración de SKU"}
        </button>
      )}
